...
<ul>
  <li>De set aan criteria moet compleet zijn én opgebouwd zijn uit onafhankelijke criteria (strategieën en maatregelpakketten mogen niet meermaals op (ongeveer) hetzelfde aspect beoordeeld worden);</li>
...
<ol>
  <li>
    De huidige DPZW-opgave en (de bandbreedte in) de toekomstige DPZW-opgave (zichtjaren 2050 en 2100) op basis van het aangescherpte DPZW-hoofddoel zoals vastgesteld in het BPZ van 5 oktober 2023:
    <br>
    <p><em>In 2050 is Nederland weerbaar tegen zoetwatertekorten. Hiermee bedoelen we dat alle sectoren goed voorbereid zijn op zoetwatertekorten om schade zo veel mogelijk te beperken. En dat Nederland een veerkrachtig en evenwichtig zoetwatersysteem heeft waarbij wateraanbod en watervraag voor alle maatschappelijke functies in evenwicht zijn tot droge periodes die vaker dan 1/20 jaar (Stoom 2023) voorkomen.</em></p>
  </li>
...
<p style='text-decoration:underline'>Deze inzichten helpen de zoetwaterregio’s en RWS bij het inventariseren van doelmatige maatregelen (stap 3) en bieden sectoren transparantie over mogelijke toekomstige zoetwatertekorten.</p>
...
<ol>
  <li><p style='text-decoration:underline'>De samenstelling van de beleidsalternatieven biedt de zoetwaterregio’s en Rijkswaterstaat informatie die richting geeft aan het trechteren van de lijst met mogelijke maatregelen naar een voorkeurspakket voor DPZW fase 3 (stap 10).</p> Als een maatregel niet in een van deze maatregelpakketten zit, kunnen er andere redenen zijn om de maatregel alsnog in het voorkeurspakket op te nemen;</li>
