...
<h4 style='color:rgb(39, 77, 141)'>Doel</h4>
...
<ol>
  <li>De huidige DPZW-opgave en (de bandbreedte in) de toekomstige DPZW-opgave (zichtjaren 2050 en 2100) op basis van het aangescherpte DPZW-hoofddoel zoals vastgesteld in het BPZ van 5 oktober 2023:
  In 2050 is Nederland weerbaar tegen zoetwatertekorten. Hiermee bedoelen we dat alle sectoren goed voorbereid zijn op zoetwatertekorten om schade zo veel mogelijk te beperken. En dat Nederland een veerkrachtig en evenwichtig zoetwatersysteem heeft waarbij wateraanbod en watervraag voor alle maatschappelijke functies in evenwicht zijn tot droge periodes die vaker dan 1/20 jaar (Stoom 2023) voorkomen.</li>
  <li>De huidige en toekomstige hydrologische knelpunten in de zoetwatervoorziening. </li>
  <li>De belangrijkste oorzaken van de geconstateerde knelpunten.</li>
</ol>
...
<ol>
  <li>Een hydrologische analyse van de doorrekening van de nieuwe deltascenario’s met het Nationaal Water Model. Op basis van doorrekeningen van langjarige reeksen wordt per deltascenario de DPZW-opgave bepaald. </li>
  <li>Hydrologische gevoeligheidsanalyses naar het effect op de DPZW-opgave (onderdeel i) van drie relevante onzekere ontwikkelingen, die geen onderdeel zijn van de deltascenario’s, op de DPZW-opgave. Onzekerheid in toekomstige klimaatverandering en sociaaleconomische ontwikkelingen is concreet gemaakt in de vorm van nieuwe deltascenario’s. De verhaallijnen van die deltascenario’s zijn gebaseerd op staand beleid. Er zijn echter ook mogelijke ontwikkelingen die nog geen staand beleid zijn, maar potentieel van grote invloed zijn op (de bandbreedte in) de toekomstige DPZW-opgave. Daarom worden als onderdeel van de KPA gevoeligheidsanalyses uitgevoerd naar de volgende drie onzekere ontwikkelingen: </li>
    <ol type='i'>
      <li>Verwezenlijking van de structurerende keuzes uit de WBS-Kamerbrief. Het gaat daarbij om structurerende keuzes en bijbehorende maatregelen die naar verwachting een significant effect hebben op de DPZW-opgave maar waarvan borging niet via het DPZW is beoogd; </li>
      <li>Bovenstroomse ontwikkelingen in watergebruik in het Rijn- en Maasstroomgebied; </li>
      <li>Veranderingen in de watervraag van stedelijk gebied door vergroening (klimaatadaptatie).</li>
    </ol>
...
<ul>
  ...
  <li>Monetarisering/kwantificering van de effecten op zoetwater gebruiksfuncties alsmede een validatie van de niet te monetariseren/kwantificeren effecten op zoetwater gebruiksfuncties (incl. keteneffecten);</li>
...
<ol>
  <li>De samenstelling van de beleidsalternatieven biedt de zoetwaterregio’s en Rijkswaterstaat informatie die richting geeft aan het trechteren van de lijst met mogelijke maatregelen naar een voorkeurspakket voor DPZW fase 3 (stap 10). Als een maatregel niet in een van deze maatregelpakketten zit, kunnen er andere redenen zijn om de maatregel alsnog in het voorkeurspakket op te nemen;</li>
  <li>Maatregelpakketten samenstellen waartegen het voorkeurspakket in de verplichte SEA afgezet kan worden.</li>
</ol>
...
<ol type='a'>
  <li>Een doelenpakket met daarin de maatregelen voor de periode 2028-2033 (DPZW fase 3) waarmee de DPZW-doelen tegen zo laag mogelijke kosten worden gehaald (kosteneffectiviteit).</li>
